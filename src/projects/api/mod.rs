...
pub async fn router(_state: AppState, _config: &Settings) -> Router<AppState, Body> {
    Router::new()
        ...
        .route_with_tsr("/api/project/:owner/:project/builds/:build_id/events", get(stream_build_log::get))
        ...
        .route_with_tsr("/api/project/:owner/:project/refs", get(view_project_refs::get))
        .route_with_tsr("/api/project/:owner/:project/file", get(view_project_file::get))
